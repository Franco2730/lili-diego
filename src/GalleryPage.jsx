...
const GalleryPage = () => {
  ...
  const products = [
    ...
    { src: '/cafetera.jpg', name: 'Cafetera PEABODY.', sold: true },
    { src: '/canasto.jpg', name: 'Canasto de ropa plegable.', sold: true },
    ...
    { src: '/juegoExterior.jpg', name: 'Juego de exterior.', sold: true },

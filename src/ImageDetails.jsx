...
const ImageDetails = () => {
  ...
  const products = [
    ...
    { src: '/fuente2.jpg', name: 'Fuente de vidrio grande', summary: 'Fuente de vidrio, ideal para servir ensaladas, frutas o como pieza decorativa en tu mesa.', price: '$8.000' },
    { src: '/fuente3.jpg', name: 'Fuente de vidrio grande', summary: 'Fuente de vidrio grande, perfecta para servir platos principales o como pieza central en tu mesa.', price: '$8.000' },
